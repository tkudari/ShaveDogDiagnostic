...
public class MediaServer {
    ...
    final private static Logger log = Logger.getLogger(MediaServer.class.getName());

    final protected UDN udn = UDN.uniqueSystemIdentifier("Sash MediaServer v1");
    ...
    public LocalDevice createDevice()
        ...
        DeviceDetails details =
                new DeviceDetails(
                        "Just a ShaveDog",
                        new ManufacturerDetails("ShaveDoggery Inc.", "somewhereOnGitHub.."),
                        new ModelDetails("ShaveMediaServer", "A test media server.", "v1")
                );
